...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (in_array('', $datos)) {
        ...
        if ($resultado === true) {
            $exito = '¡Registro exitoso! Tu cuenta ha sido creada y está pendiente de aprobación por un administrador. Te notificaremos por correo cuando sea activada.';
            // Limpiar datos del formulario para que no se rellenen automáticamente
            $datos = [];
        } else {
            $error = $resultado;
        }
