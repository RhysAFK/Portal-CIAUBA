...
<body>
    ...
    <main>
        <section class="club-info">
            ...
            <article class="info-section">
                <h3>Asesores</h3>
                <p>Nuestro club se sostiene con el apoyo de dedicados meimbros de la facultad que proveen guía y garantizan la alineación con los objetivos académicos:</p>
                <ul>
                    <li><strong>Dr. Elena Martinez</strong> - Department of Electrical Engineering</li>
                    <li><strong>Prof. James Wilson</strong> - Department of Mechanical Engineering</li>
                    <li><strong>Dr. Sarah Johnson</strong> - Department of Computer Science</li>
                </ul>
            </article>
